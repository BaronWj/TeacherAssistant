...
- (void)viewDidLoad {
    ...
    self.people_tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 5, ScreenWidth, ScreenHeight) style:UITableViewStylePlain];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.row == 0){
        ...
        UILabel * nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(90, 5, 100, 30)];
        nameLabel.text = @"公孙绿萼";
