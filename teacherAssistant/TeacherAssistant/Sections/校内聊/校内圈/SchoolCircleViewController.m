...
@interface SchoolCircleViewController ()<UITableViewDataSource,UITableViewDelegate,cellDelegate,InputDelegate>
{
...
@implementation SchoolCircleViewController
