...
@interface SchoolChatViewController ()<MLKMenuPopoverDelegate,UIScrollViewDelegate>
{
...
@implementation SchoolChatViewController
...
//    self.view.backgroundColor = [UIColor redColor];
    ...
    _schoolChat_scro.backgroundColor =[UIColor clearColor];
