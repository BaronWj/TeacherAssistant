...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    CGFloat VCWidth = ScreenWidth;
    CGFloat VCHeight = ScreenHeight;
    CGRect frame = CGRectMake(0, VCHeight-110, VCWidth, 40);
...
-(void)keyboardDidShowOrHide:(NSNotification *)notification
{
    ...
    newFrame.origin.y = keyboardEndFrame.origin.y - newFrame.size.height-90;
    self.frame = newFrame;
