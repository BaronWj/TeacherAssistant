...
//
    ...
    _firstbuttonW = [self calculateSizeWithFont:15 Width:MAXFLOAT Height:conditionScrollH Text:[array_title firstObject]].size.width;
...
-(void)createButton :(NSArray *)buttonTitle{
    ...
    if([top_scroller subviews]){
        ...
        for (int i = 0; i < [buttonTitle count]; i++) {
            CGFloat buttonW = [self calculateSizeWithFont:15 Width:MAXFLOAT Height:conditionScrollH Text:[buttonTitle objectAtIndex:i]].size.width;
